...
<body>
    ...
    <div class="w3-container">
        <div class="w3-sidebar w3-light-grey w3-bar-block w3-border" style="width:15%; height:640px;">
            <p class="w3-bar-item menu-label">vishal.kondle@gmail.com</p>
            <a href="mail.php" class="w3-bar-item w3-button">Inbox</a>
            <a href="starred.php" class="w3-bar-item w3-button">Starred</a>
            <a href="sent.php" class="w3-bar-item w3-button">Sent</a>
        </div>
        <div style="margin-left:15%; height:640px; overflow-y: scroll;" class="w3-light-grey w3-border">
            ...
            <table class="table" id="id01">
                ...
                <tbody>
                    <?php
                    $query = mysqli_query($conn, "SELECT * FROM inbox WHERE receiver='vishalkondle@gmail.com'");
                    ...
                    ?>
                        <tr class="item">
                            ...
                            <td><a href="mail.php?id=1"><?php echo $row['subject']; ?></a></td>
