...
<?php
            ...
            $receiver = $row1['id'];
            $posts = mysqli_query($conn, "SELECT * FROM `posts` WHERE `userid`='0' AND college_id= '$collegeid'");
...
<body>
        ...
        <div class="w3-col" style="width:60%">
            ...
            <div class="w3-container w3-row">
                ...
                <div class="w3-col" style="width:30%">
                    ...
                    ?>
                    <!-- <?php echo mysqli_num_rows($query7); ?> -->
                </div>
                <!-- Bio -->
                <div class="w3-col" style="width:70%">
                    <h3><?php echo $row1['username']; ?>
                        <?php
                                                                                                                                                                                                            if ($key != $college_name && $receiver != $userid) {
                                                                                                                                                                                                                $id = $row1['id'];
            ...
            <div class="tabs is-centered">
                <ul>
                    ...
                    <?php if ($userid == $receiver && $key != $college_name) { ?>
            ...
            <!-- Posts -->
            <div class="posts">
                <?php if (mysqli_num_rows($query7) || $receiver == $userid) { ?>
    ...
    <?php if ($key != $college_name) {
        if (mysqli_num_rows($query7) > 0 || $receiver == $userid) {
    ?>
