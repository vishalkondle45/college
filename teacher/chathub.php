            ...
            ?>
                ...
                <div class="w3-border w3-container w3-white" style="height:504px; overflow-y:scroll;" id="messages">
                    ...
                    ?>
                                <center>
                                    <br>
                                    <p class="w3-border w3-round w3-light-blue w3-container" id="" style="width: max-content"><?php echo "Today"; ?></p>
                                </center>
                            <?php
                            } else {
                            ?>
                                <center>
                                    <br>
                                    <p class="w3-border w3-round w3-light-blue w3-container" id="" style="width: max-content"><?php echo $lm; ?></p>
                                </center>
                        <?php
                            }
                        }
                ...
                <input type="hidden" id="dated" class="dated" value="<?php echo $dated; ?>">
                <input type="hidden" id="today" class="today" value="<?php echo $today = date("d-m-Y", time());; ?>">
    ...
    $(document).ready(function() {
        ...
        $('#message').keypress(function(event) {
            ...
            if (keycode == '13' && message != '') {
                if (dated != today) {
                    var s = '<center><br><p class = "w3-border w3-round w3-light-blue w3-container" id = "" style = "width: max-content" > ' + "Today" + ' </p> </center>';
                    $(".dated").val(today);
                }
