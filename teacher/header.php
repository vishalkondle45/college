        ...
        <div class="navbar-start">
            ...
            <div class="navbar-item has-dropdown is-hoverable">
                ...
                <div class="navbar-dropdown is-boxed">
                    ...
                    <a class="navbar-item" href="chathub.php">
                        <b>
            ...
            <a href="assignment.php" class="navbar-item">
            ...
            <a href="submission.php" class="navbar-item">
                <i class="fa fa-check-circle"></i>
                &nbsp;
                Submissions
            </a>
            <a href="noticeboard.php" class="navbar-item">
